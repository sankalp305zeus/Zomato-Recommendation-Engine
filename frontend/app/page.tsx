...
type View = 'form' | 'loading' | 'results' | 'empty' | 'error';
...
export default function Home() {
  ...
  async function handleSubmit(req: RecommendationRequest) {
    ...
    // brief pause so "Filtering" step is visible
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/2 flex flex-col justify-center">
              ...
              <p className="text-secondary text-sm mb-6">
                Tell us what you want. Our AI searches {health ? health.catalog_size.toLocaleString() : '40,000'}+ restaurants and explains every pick.
              </p>
              <div className="flex flex-col gap-3">
                {[
                  ['🔍', 'Filter',    'We narrow the catalog to relevant matches'],
            ...
            <div className="lg:w-1/2 bg-white rounded-3xl p-6 shadow-sm border border-outline">
              <h2 className="text-lg font-extrabold text-on-surface mb-4">Your preferences</h2>
              <PreferenceForm
